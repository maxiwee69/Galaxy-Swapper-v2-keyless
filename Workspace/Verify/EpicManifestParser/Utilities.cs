...
namespace LilySwapper.Workspace.Verify.EpicManifestParser;
...
internal static unsafe class Utilities
{
    ...
    private static readonly uint* _lookup32UnsafeP =
    ...
    public static string StringBlobToHexString(ReadOnlySpan<byte> stringBlob, bool reversed = false)
    {
        ...
        fixed (char* resultP = result)
        {
            ...
            for (var i = 0; i < length; i++) resultP2[i] = lookupP[bpBuffer[i]];
        }
