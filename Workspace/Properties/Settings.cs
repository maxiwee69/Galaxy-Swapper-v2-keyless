...
public static class Settings
{
    ...
    public static Dictionary<string, dynamic> Cache = new();
    ...
    private static bool IsValid()
    {
        ...
        foreach (var Key in Enum.GetNames(typeof(Type)))
            if (parse[Key] == null)
                return false;
    ...
    public static void Edit(Type Key, JToken Value)
    {
        ...
        foreach (var Object in Cache) NewObject.Add(Object.Key, Object.Value);
