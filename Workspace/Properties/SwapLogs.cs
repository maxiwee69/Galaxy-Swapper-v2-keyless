...
public static class SwapLogs
{
    ...
    public static void Add(string Name, string Icon, string OverrideIcon, int AssetCount, List<string> UcasList,
        List<string> UtocList, bool UEFNFormat = false)
    {
    ...
    {
        foreach (var Cosmetic in Cache)
            if (Cosmetic["Name"].Value<string>() != Name && !Cosmetic["UEFNFormat"].KeyIsNullOrEmpty() &&
                Cosmetic["UEFNFormat"].Value<bool>())
            {
